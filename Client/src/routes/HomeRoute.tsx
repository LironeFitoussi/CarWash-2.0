    ...
    <div className="min-h-screen">
      ...
      <section className="container mx-auto py-20 text-center">
        ...
        >
          ...
          <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground">
            Experience the finest car care services with our state-of-the-art facilities
            and expert detailing team.
          </p>
      ...
      <section className="container mx-auto py-20">
        <div className="grid gap-12 md:grid-cols-2">
          <div>
            <h2 className="mb-6 text-3xl font-bold">Why Choose Our Service?</h2>
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span>Quick service, amazing results</span>
              </li>
            </ul>
          </div>
          <div className="relative rounded-lg bg-muted/30 p-6">
            ...
            <div className="relative">
              ...
              <p className="text-muted-foreground">
                We use only the highest quality products and equipment to ensure your
      ...
      {/* CTA Section */}
      <section className="container mx-auto py-20 text-center">
        <h2 className="mb-6 text-3xl font-bold">Ready to Experience the Best Car Wash?</h2>
      ...
      <footer className="border-t bg-muted/30">
        <div className="container mx-auto py-8">
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div>
              <h3 className="mb-4 font-bold">Hours</h3>
              <p className="text-sm text-muted-foreground">
